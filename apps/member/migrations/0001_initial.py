...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'I4pProfile'
        db.create_table('member_i4pprofile', (
            ...
            ('language', self.gf('django.db.models.fields.CharField')(default='en', max_length=4)),
            ('about', self.gf('django.db.models.fields.TextField')()),
            ('website', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('address', self.gf('django.db.models.fields.TextField')()),
            ('country', self.gf('django_countries.fields.CountryField')(max_length=2)),
        ))
        db.send_create_signal('member', ['I4pProfile'])


    def backwards(self, orm):
        
        # Deleting model 'I4pProfile'
        db.delete_table('member_i4pprofile')
