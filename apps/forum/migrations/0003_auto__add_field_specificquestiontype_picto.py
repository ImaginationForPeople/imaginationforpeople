...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpecificQuestionType.picto'
        db.add_column('forum_specificquestiontype', 'picto',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpecificQuestionType.picto'
        db.delete_column('forum_specificquestiontype', 'picto')
    ...
    models = {
        ...
        'forum.specificquestiontype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'picto': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
