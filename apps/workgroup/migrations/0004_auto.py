...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field projects on 'WorkGroup'
        db.create_table('workgroup_workgroup_projects', (
        ...
        db.create_unique('workgroup_workgroup_projects', ['workgroup_id', 'i4pproject_id'])


    def backwards(self, orm):
        # Removing M2M table for field projects on 'WorkGroup'
        db.delete_table('workgroup_workgroup_projects')
