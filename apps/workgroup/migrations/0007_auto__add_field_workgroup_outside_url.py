...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkGroup.outside_url'
        db.add_column('workgroup_workgroup', 'outside_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkGroup.outside_url'
        db.delete_column('workgroup_workgroup', 'outside_url')
