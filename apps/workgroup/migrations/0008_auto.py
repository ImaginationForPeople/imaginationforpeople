...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subscribers on 'WorkGroup'
        db.create_table('workgroup_workgroup_subscribers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workgroup', models.ForeignKey(orm['workgroup.workgroup'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('workgroup_workgroup_subscribers', ['workgroup_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field subscribers on 'WorkGroup'
        db.delete_table('workgroup_workgroup_subscribers')
