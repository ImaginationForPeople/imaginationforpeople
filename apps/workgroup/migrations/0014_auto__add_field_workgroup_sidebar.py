...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkGroup.sidebar'
        db.add_column('workgroup_workgroup', 'sidebar',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkGroup.sidebar'
        db.delete_column('workgroup_workgroup', 'sidebar_id')
