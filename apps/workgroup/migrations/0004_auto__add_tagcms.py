...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagCMS'
        db.create_table('cmsplugin_tagcms', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project_sheet.Objective'])),
        ))
        db.send_create_signal('workgroup', ['TagCMS'])


    def backwards(self, orm):
        # Deleting model 'TagCMS'
        db.delete_table('cmsplugin_tagcms')
    ...
    models = {
        ...
        'workgroup.tagcms': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['project_sheet.Objective']"})
        },
        'workgroup.workgroup': {
