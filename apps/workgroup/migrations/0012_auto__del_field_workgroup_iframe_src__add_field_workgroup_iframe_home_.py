...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkGroup.iframe_src'
        db.delete_column('workgroup_workgroup', 'iframe_src')

        # Adding field 'WorkGroup.iframe_home_src'
        db.add_column('workgroup_workgroup', 'iframe_home_src',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkGroup.iframe_description_src'
        db.add_column('workgroup_workgroup', 'iframe_description_src',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WorkGroup.iframe_src'
        db.add_column('workgroup_workgroup', 'iframe_src',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'WorkGroup.iframe_home_src'
        db.delete_column('workgroup_workgroup', 'iframe_home_src')

        # Deleting field 'WorkGroup.iframe_description_src'
        db.delete_column('workgroup_workgroup', 'iframe_description_src')
