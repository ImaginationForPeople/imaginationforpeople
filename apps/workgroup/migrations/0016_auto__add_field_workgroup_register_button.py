...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkGroup.register_button'
        db.add_column('workgroup_workgroup', 'register_button',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkGroup.register_button'
        db.delete_column('workgroup_workgroup', 'register_button')
