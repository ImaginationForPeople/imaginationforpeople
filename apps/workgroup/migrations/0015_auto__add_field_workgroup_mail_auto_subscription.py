...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkGroup.mail_auto_subscription'
        db.add_column('workgroup_workgroup', 'mail_auto_subscription',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkGroup.mail_auto_subscription'
        db.delete_column('workgroup_workgroup', 'mail_auto_subscription')
