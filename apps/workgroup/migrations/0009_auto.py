...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field questions on 'WorkGroup'
        db.create_table('workgroup_workgroup_questions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workgroup', models.ForeignKey(orm['workgroup.workgroup'], null=False)),
            ('thread', models.ForeignKey(orm['askbot.thread'], null=False))
        ))
        db.create_unique('workgroup_workgroup_questions', ['workgroup_id', 'thread_id'])


    def backwards(self, orm):
        # Removing M2M table for field questions on 'WorkGroup'
        db.delete_table('workgroup_workgroup_questions')
    ...
    models = {
        ...
        'workgroup.workgroup': {
            ...
            'questions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'workgroups'", 'blank': 'True', 'to': "orm['askbot.Thread']"}),
