...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SiteTopic', fields ['topic', 'site']
        db.create_unique('project_sheet_sitetopic', ['topic_id', 'site_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SiteTopic', fields ['topic', 'site']
        db.delete_unique('project_sheet_sitetopic', ['topic_id', 'site_id'])
