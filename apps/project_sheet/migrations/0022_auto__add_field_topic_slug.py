...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('project_sheet_topic', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='bobleponge', unique_with=(), max_length=50, populate_from=None, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.slug'
        db.delete_column('project_sheet_topic', 'slug')
