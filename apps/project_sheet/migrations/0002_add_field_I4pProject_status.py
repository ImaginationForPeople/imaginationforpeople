...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'I4pProject.status'
        db.add_column('project_sheet_i4pproject', 'status', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'I4pProject.status'
        db.delete_column('project_sheet_i4pproject', 'status')
