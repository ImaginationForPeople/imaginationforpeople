...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'I4pProject.objective'
        db.delete_column('project_sheet_i4pproject', 'objective')


    def backwards(self, orm):
        
        # Adding field 'I4pProject.objective'
        db.add_column('project_sheet_i4pproject', 'objective', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)
