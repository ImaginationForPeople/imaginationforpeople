...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectFan'
        db.create_table('project_sheet_projectfan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='detailed_fans', to=orm['project_sheet.I4pProject'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_fans', to=orm['auth.User'])),
            ('fan_since', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('project_sheet', ['ProjectFan'])

        # Adding unique constraint on 'ProjectFan', fields ['project', 'user']
        db.create_unique('project_sheet_projectfan', ['project_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectFan', fields ['project', 'user']
        db.delete_unique('project_sheet_projectfan', ['project_id', 'user_id'])

        # Deleting model 'ProjectFan'
        db.delete_table('project_sheet_projectfan')
