...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'I4pProjectTranslation.modified'
        db.add_column('project_sheet_i4pprojecttranslation', 'modified', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        for v in Version.objects.all():
            v.save() # send a post_save signal to project_sheet.models.last_modification_date in order to update empty "modified" field

    def backwards(self, orm):

        # Deleting field 'I4pProjectTranslation.modified'
        db.delete_column('project_sheet_i4pprojecttranslation', 'modified')
