...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'I4pProject.cover_picture'
        db.add_column('project_sheet_i4pproject', 'cover_picture',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project_sheet.ProjectPicture'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'I4pProject.cover_picture'
        db.delete_column('project_sheet_i4pproject', 'cover_picture_id')
