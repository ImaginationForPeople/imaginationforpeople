...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'I4pProject.location'
        db.delete_column('project_sheet_i4pproject', 'location_id')

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration.  Location data for all projects would be lost")
        # Adding field 'I4pProject.location'
        db.add_column('project_sheet_i4pproject', 'location',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['i4p_base.Location'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'project_sheet.i4pproject': {
            ...
            'location': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['i4p_base.Location']", 'symmetrical': 'False'}),
