...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VersionActivity.diffs'
        db.add_column('project_sheet_versionactivity', 'diffs',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


        # Changing field 'VersionActivity.action'
        db.alter_column('project_sheet_versionactivity', 'action_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['actstream.Action']))
        # Adding unique constraint on 'VersionActivity', fields ['action']
        db.create_unique('project_sheet_versionactivity', ['action_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VersionActivity', fields ['action']
        db.delete_unique('project_sheet_versionactivity', ['action_id'])

        # Deleting field 'VersionActivity.diffs'
        db.delete_column('project_sheet_versionactivity', 'diffs')


        # Changing field 'VersionActivity.action'
        db.alter_column('project_sheet_versionactivity', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['actstream.Action']))
    ...
    models = {
        ...
        'project_sheet.versionactivity': {
            'Meta': {'object_name': 'VersionActivity'},
            'action': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'version'", 'unique': 'True', 'to': "orm['actstream.Action']"}),
            'diffs': ('django.db.models.fields.TextField', [], {'default': "'{}'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
