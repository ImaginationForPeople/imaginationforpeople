...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'I4pProjectTranslation.completion_progress'
        db.add_column('project_sheet_i4pprojecttranslation', 'completion_progress', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'I4pProjectTranslation.completion_progress'
        db.delete_column('project_sheet_i4pprojecttranslation', 'completion_progress')
    ...
    models = {
        ...
        'project_sheet.i4pprojecttranslation': {
            ...
            'completion_progress': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
