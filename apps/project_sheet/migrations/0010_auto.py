...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field objectives on 'I4pProject'
        db.create_table('project_sheet_i4pproject_objectives', (
        ...
        db.create_unique('project_sheet_i4pproject_objectives', ['i4pproject_id', 'objective_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field objectives on 'I4pProject'
        db.delete_table('project_sheet_i4pproject_objectives')
