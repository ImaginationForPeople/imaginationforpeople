...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ObjectiveTranslation'
        db.create_table('project_sheet_objectivetranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['project_sheet.Objective'])),
        ))
        db.send_create_signal('project_sheet', ['ObjectiveTranslation'])

        # Adding unique constraint on 'ObjectiveTranslation', fields ['language_code', 'master']
        db.create_unique('project_sheet_objectivetranslation', ['language_code', 'master_id'])

        # Adding model 'Objective'
        db.create_table('project_sheet_objective', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('project_sheet', ['Objective'])

        # Adding M2M table for field objective on 'I4pProject'
        db.create_table('project_sheet_i4pproject_objective', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('i4pproject', models.ForeignKey(orm['project_sheet.i4pproject'], null=False)),
            ('objective', models.ForeignKey(orm['project_sheet.objective'], null=False))
        ))
        db.create_unique('project_sheet_i4pproject_objective', ['i4pproject_id', 'objective_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ObjectiveTranslation', fields ['language_code', 'master']
        db.delete_unique('project_sheet_objectivetranslation', ['language_code', 'master_id'])

        # Deleting model 'ObjectiveTranslation'
        db.delete_table('project_sheet_objectivetranslation')

        # Deleting model 'Objective'
        db.delete_table('project_sheet_objective')

        # Removing M2M table for field objective on 'I4pProject'
        db.delete_table('project_sheet_i4pproject_objective')
