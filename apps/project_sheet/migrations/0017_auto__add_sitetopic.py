...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SiteTopic'
        db.create_table('project_sheet_sitetopic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project_sheet.Topic'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('project_sheet', ['SiteTopic'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SiteTopic'
        db.delete_table('project_sheet_sitetopic')
    ...
    models = {
        ...
        'project_sheet.sitetopic': {
            'Meta': {'object_name': 'SiteTopic'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['project_sheet.Topic']"})
        },
        'project_sheet.topic': {
