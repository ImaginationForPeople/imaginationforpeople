...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'I4pProjectTranslation.partners_section'
        db.add_column('project_sheet_i4pprojecttranslation', 'partners_section', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'I4pProjectTranslation.partners_section'
        db.delete_column('project_sheet_i4pprojecttranslation', 'partners_section')
