...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field site on 'I4pProject'
        db.create_table('project_sheet_i4pproject_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('i4pproject', models.ForeignKey(orm['project_sheet.i4pproject'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('project_sheet_i4pproject_site', ['i4pproject_id', 'site_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field site on 'I4pProject'
        db.delete_table('project_sheet_i4pproject_site')
