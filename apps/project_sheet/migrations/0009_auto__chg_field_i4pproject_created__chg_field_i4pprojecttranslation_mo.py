...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'I4pProject.created'
        db.alter_column('project_sheet_i4pproject', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'I4pProjectTranslation.modified'
        db.alter_column('project_sheet_i4pprojecttranslation', 'modified', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'I4pProject.created'
        db.alter_column('project_sheet_i4pproject', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'I4pProjectTranslation.modified'
        db.alter_column('project_sheet_i4pprojecttranslation', 'modified', self.gf('django.db.models.fields.DateField')(null=True))
